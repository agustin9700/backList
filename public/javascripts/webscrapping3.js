...
async function ejecutarProcesoVariasVeces3() {
    const url = 'https://ninjakaizen.com/clan/159';

    try {
        for (let i = 0; i < 999; i++) {
            const nombres = ['datos3.json', 'newdatos3.json'];
            ...
            fs.writeFileSync('resultado_resta3.json', JSON.stringify(resultadoResta2, null, 2), 'utf-8');
            console.log('Resultado de la resta guardado en resultado_resta3.json');
        }
    } catch (error) {
...
module.exports = { ejecutarProcesoVariasVeces3 };

...
async function ejecutarProcesoVariasVeces4() {
    const url = 'https://ninjakaizen.com/clan/159';

    try {
        for (let i = 0; i < 999; i++) {
            const nombres = ['datos4.json', 'newdatos4.json'];
            ...
            fs.writeFileSync('resultado_resta4.json', JSON.stringify(resultadoResta2, null, 2), 'utf-8');
...
module.exports = { ejecutarProcesoVariasVeces4 };
